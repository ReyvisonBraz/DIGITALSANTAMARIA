    ...
    <>
      <header className={cn(
        ...
        scrolled ? "pt-4 px-4" : "pt-0 px-0 md:pt-6 md:px-6"
          ...
          >
            {/* Left Section: Brand & Vital Links */}
            <div className="flex items-center gap-2 md:gap-8 min-w-0">
               ...
               {/* Explorer Button - Intelligent Navigation */}
               <button 
               ...
               >
                  ...
                  <ChevronDown className="w-3 h-3 text-text-muted opacity-50 hidden sm:block" />
               </button>
            </div>

            {/* Center Section: Smart Command Center */}
            ...
            <div className="flex items-center gap-1 md:gap-3 shrink-0">
              ...
              {/* Accessibility Control Popover Trigger */}
              <div className="relative">
                ...
                >
                  ...
                  {highContrast && <span className="absolute top-1 right-1 w-2 h-2 bg-green-500 border-2 border-white rounded-full animate-pulse" />}
                </button>
                  ...
                  {isAccessibilityMenuOpen && (
                    ...
                    >
                       <div className="flex items-center justify-between mb-6">
                          ...
                          <button onClick={() => setIsAccessibilityMenuOpen(false)} className="hover:text-primary transition-colors px-1 text-text-muted"><X className="w-4 h-4" /></button>
                       </div>
              ...
              >
                ...
                <span className="absolute top-2 right-2 md:top-2.5 md:right-2.5 w-2 md:w-3.5 h-2 md:h-3.5 bg-accent-danger rounded-full border-2 md:border-4 border-white shadow-sm" />
              </button>
      ...
      {/* Explorer Overlay - Full Screen Intelligent App Drawer */}
      <AnimatePresence>
        {isExplorerOpen && (
          <motion.div 
            initial={{ opacity: 0 }}
                ...
                <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8">
                   <div className="flex items-center gap-6">
                      <div className="text-center md:text-left">
                         <span className="block text-2xl font-black text-white tabular-nums">22</span>
