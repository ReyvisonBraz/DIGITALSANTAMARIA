            ...
            <ContentCard
              ...
              extra={
                <div className="space-y-2 pt-2">
                  <div className="flex items-center justify-between text-[11px] font-semibold text-text-muted uppercase tracking-widest">
                    <span>Progresso</span>
                  ...
                  <p className="text-[11px] font-semibold text-text-muted uppercase">
